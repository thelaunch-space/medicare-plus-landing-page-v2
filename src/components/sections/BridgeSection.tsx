...
export const BridgeSection: React.FC = () => {
  ...
  return (
    <section className="py-12 bg-metallic-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div
          ref={ref}
          className={`bg-gradient-to-r from-metallic-silver to-metallic-platinum rounded-2xl p-8 md:p-12 border border-accent-teal/20 transition-all duration-700 ${
